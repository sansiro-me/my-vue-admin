<template>
  <aside class="aside__top">
    <span class="icon-list toggleNavCollapse" :class="{active:isSidebarNavCollapse}" @click="toggleNavCollapse" >
    </span>
...
export default {
  ...
  //   crumbList: () => this.$store.crumbList,
  //   isSidebarNavCollapse: () => this.$store.isSidebarNavCollapse
  // },
  mounted() {
    this.crumbList = this.$store.state.crumbList;
